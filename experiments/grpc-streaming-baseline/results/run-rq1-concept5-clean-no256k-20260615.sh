...
LOG=/home/nebur/Streaming_Techniques_Experiment/experiments/grpc-streaming-baseline/results/rq1-concept5-clean-no256k-20260615.log
rm -f "${LOG}"
...
env \
  ...
  ./scripts/run-k8s-matrix.sh synthetic-clean \
    ...
    --repeat 5 \
    --run-id-prefix rq1-concept5-clean-no256k-20260615- \
    --transport all \
