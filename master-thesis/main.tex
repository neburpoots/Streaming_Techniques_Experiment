...
\begin{figure*}[!b]
    ...
    \caption{Phase 1 evaluation map showing the common benchmark pipeline and the four scenario probes used to operationalize the literature-backed evaluation dimensions.}
